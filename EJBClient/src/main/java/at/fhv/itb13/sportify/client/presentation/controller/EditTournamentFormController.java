...
public class EditTournamentFormController {
    ...
    private void saveEditTournament() throws RemoteException, NotAuthorizedException {
        ...
        if (createOrUpdateTournamentDTO()) {
            ...
            initSuccessAlert();
            SimpleTournamentDTO simpleTournamentDTO = ServiceLocator.getInstance().getRemote(SessionRemote.class).getTournamentRemote().getSimpleTournamentDTOByID(_tournament.getId());
