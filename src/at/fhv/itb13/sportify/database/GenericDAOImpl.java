...
abstract class GenericDAOImpl<T extends PersistentObject, PK extends Serializable> implements GenericDAO<T, PK> {
    ...
    /**
     * @see at.fhv.itb13.sportify.database.GenericDAO#createOrUpdate(PersistentObject)
    ...
    /**
     * @see at.fhv.itb13.sportify.database.GenericDAO#update(PersistentObject)
    ...
    /**
     * @see at.fhv.itb13.sportify.database.GenericDAO#delete(PersistentObject)
